...
import {useUpdateSearchParamsInSearchBar} from "@/hooks/useUpdateSearchParamsInSearchBar";
...
const SearchBar = () => {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    useUpdateSearchParamsInSearchBar(model.toLowerCase(), manufacturer.toLowerCase());
  };
